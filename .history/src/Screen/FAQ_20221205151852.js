            ...
            <>
              <div className="new">
                <div className="up">
                  ...
                  <p style={{ marginTop: "0" }}>
                  The delivery takes around 15-18 days. You can enter your location's pincode on the <br />
product page to check when you can expect to receive the delivery.
                  </p>
                </div>
                <div className="down">
                  <img
              ...
              <div className="new">
                <div className="up">
                  ...
                  <p style={{ marginTop: "0" }}>
                  You can track your order as soon as it is shipped out. To track your order in real time <br />
you can tap on the link provided in the email sent to you/tracking page on the website.
                  </p>
                </div>
                <div className="down">
                  <img
              ...
              <div className="new">
                <div className="up">
                  ...
                  <p style={{ marginTop: "0" }}>
                  We recommend that you receive the order yourself to ensure complete satisfaction. <br />
If in any case you are unable to receive the order, it will be delivered to the person <br /
available. The signature of the receiver will be taken at the time of delivery for security
and validation.
                  </p>
                </div>
                <div className="down">
