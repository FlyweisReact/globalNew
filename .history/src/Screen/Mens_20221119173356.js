  ...
  return (
    <>
      ...
      <div className="men-b">
        <div className="left">
          <h1>
            Shop for <strong>$100</strong>
            and stand  a chance to win a customized Satchel bag.
          </h1>
        </div>
        <div className="right">
          <img src={New} alt='' />
      ...
      <div className="product">
        ...
        <Card className="ProductCard">
          <Card.Body>
            <img src={img4} alt="" style={{paddingTop : '50px'}} />
          </Card.Body>
        </Card>
        <div className="desc2">
          <p>
      ...
      <div className="photo">
        ...
        <div className="right">
          <div className="up">
            ...
            <div className="images"  >
              <img src={img14} alt=""  style={{   paddingTop : '120px' }} />
              <p>
          ...
          <div className="up">
            ...
            <div className="images">
              <img src={img16} alt="" style={{paddingTop : '150px' , paddingBottom : '100px' }} />
              <p>
                Meta Quest 2 — Advanced All-In-One Virtual Reality <br />
                Headset — 128 GB
                <br />
