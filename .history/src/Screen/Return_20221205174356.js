  ...
  return (
    <>
      ...
      <div className="MyOrderFour">
        ...
        <h3 onClick={() => navigate('/inTransit')}>Cancelled</h3>
        <h3 onClick={() => navigate('/inTransit')}>Buy it Again</h3>
      </div>
      ...
      <div className="MyOrderTwoSec">
        <div className="left">
          ...
          <div className="return">
            ...
            <button onClick={() => navigate('/returnRefundPolicy')}>See Return Policy </button>
            <br />
