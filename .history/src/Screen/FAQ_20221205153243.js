        ...
        <div className="right">
          ...
          {other ? (
            <>
              <div className="new">
                <div className="up">
                  <h4>I need to contact The Global Genie for another reason.</h4>
                  <p style={{ marginTop: "0" }}>
                  You can contact us for non-product queries through Legal (add a link for the legal page <br />
on the word legal )
                  </p>
                </div>
                <div className="down">
              ...
              <div className="new">
                <div className="up">
                  <h4>Do you provide membership? If yes, then what are  <br />
the benefits?</h4>
                  <p style={{ marginTop: "0" }}>
                  No, we do not offer any membership. If you get any message/email regarding  <br />
The Global Genie membership, please refrain from providing personal information 
and do bring it to our attention by sending an email at ABC @gmail.com.
                  </p>
                </div>
                <div className="down">
                  <img
