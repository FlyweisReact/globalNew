  ...
  return (
    <>
      ...
      <div className="FAQtwosec">
        ...
        <div style={{ borderRight: "1px solid black", width: "5px" , height : '100vh' }}></div>
          ...
          <div className="new">
            <div className="up">
              ...
              <p style={{ marginTop: "0" }}>
                ...
                Same will be   <br />updated on
                the homepage and product page as well. We recommend signing up
                for our newsletters 
