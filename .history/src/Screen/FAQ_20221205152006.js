          ...
          {shipping ? (
            <>
              ...
              <div className="new">
                <div className="up">
                  <h4>
                  Can I cancel shipped order?
                  </h4>
                  <p style={{ marginTop: "0" }}>
                  You can cancel your order 4-5 days prior to shipping. Once it is shipped, you cannot <br />
cancel your order. However, you can change your contact details or shipping address  <br />
