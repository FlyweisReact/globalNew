            ...
            <>
              <div className="new">
                <div className="up">
                  ...
                  <p style={{ marginTop: "0" }}>
                  We have a customer friendly return policy. You can return the products within 7 days <br />
of delivery as long as the following conditions are met:
<ul>
  <li>Should be unused – Make sure that any smell does not transfer to the product <br />
(natural body odour, body deodorant, perfume etc.) when checking for fit and comfort</li>
