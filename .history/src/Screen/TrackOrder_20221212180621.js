    ...
    <>
      ...
      <div className="MyOrderHead">
        ...
        <div className="SS">
          ...
          <div>
            <input type="text" onChange={() => setFill(true)} />
            {fill ?  <button onClick={() => setShow(true)}>Track</button> :   <button style={{backgroundColor : '#d8d8d8' , color : 'black'   , border : '1px solid #d8d8d8'}}>Track</button>}
