  ...
  return (
    <>
      ...
      <div className="returnRefundPdiv2">
        ...
        <p>We may need to request a photo or a short video showing the defect/damage on the products received, as it is <br />
a requirement from merchants for refund/replacement and quality purposes. </p>
      </div>
    </>
  );
};
