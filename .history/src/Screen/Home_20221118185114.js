...
const Home = () => {
  return (
    <>
      ...
      <div className="product">
        <Card className="ProductCard" style={{paddingTop : '40px' , width : '350px'}}>
          <Card.Body>
            <img src={img8} alt="" />
          </Card.Body>
        </Card>
      ...
      <div className="product">
        <Card className="ProductCard" style={{paddingTop : '80px' , width : '350px'}}>
          <Card.Body>
            <img src={img17} alt="" />
          </Card.Body>
        </Card>
        ...
        <Card className="ProductCard" style={{ width: "350px" , paddingTop : '80px' }}>
          <Card.Body>
            <img src={img19} alt="" />
          </Card.Body>
        </Card>
