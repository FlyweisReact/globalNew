  ...
  return (
    <>
      ...
      <div className="product">
        ...
        <Card className="ProductCard"  onClick={() => NavigationHandler("/single")}>
          <Card.Body>
        ...
        <div className="right">
          <div className="up">
            <div className="images" >
              <img src={Bag} alt=""  onClick={() => NavigationHandler("/single")} />
              <p>
                Meta Quest 2 — Advanced All-In-One Virtual Reality
                <br />
                Headset — 128 GB
          ...
          <div className="up">
            ...
            <div className="images">
              <img src={Head} alt=""   onClick={() => NavigationHandler("/single")}/>
              <p>
                Meta Quest 2 — Advanced All-In-One Virtual Reality <br />
                Headset — 128 GB
                <br />
      ...
      <h1 style={{ textAlign: "center", fontFamily: "Monument" }} className='forRes'>
        RECENTLY VIEWED
      </h1>
