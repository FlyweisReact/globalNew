    ...
    <>
      ...
      <div className="returnRefundPdiv2">
        ...
        <p>
          ...
          about yourself. However, you will not stay <br /> anonymous to us once you
        ...
        <p>
          ...
          number, credit card/debit card and <br /> other payment instrument details)
          from you when you set up an account or transact with us or participate
          in any event <br />  or contest.
        </p>
        <p>
        We collect personal information by lawful and fair means – with appropriate knowledge and consent of the individual. <br />
