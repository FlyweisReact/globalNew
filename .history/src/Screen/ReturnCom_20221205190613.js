  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title id="contained-modal-title-vcenter" style={{backgroundColor : '#707070'}}>
        Change Address
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
          ...
          <div className="down">
            ...
            <div style={{ marginTop: "5%" }}>
              <div>
                ...
                <p style={{ color: "blue", cursor : 'pointer'  }} onClick={() => setModalShow(true)}>
                  Change
                </p>
              </div>
              ...
              <div>
                ...
                <p style={{ color: "blue" , cursor : 'pointer' }}>Change address </p>
              </div>
