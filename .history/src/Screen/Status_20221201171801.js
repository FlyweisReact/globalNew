      ...
      <div className="StatusRefundBox">
        <div className="left">
            <div>
                ...
                <img src='https://cdn.pixabay.com/photo/2016/01/20/18/59/confirmation-1152155_960_720.png' alt='' style={{width : '50px'}} />
                <div>
                <h2 style={{color : '#43a047'}}>Replacement Requested</h2>
                    <p>Replacement Order : 1287459321</p>
                </div>
            </div>
        </div>
        <div className="right" >
