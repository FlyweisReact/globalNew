            ...
            <>
              <div className="new">
                <div className="up">
                  ...
                  <p style={{ marginTop: "0" }}>
                  The refund duration varies according to the FOP (Form of Payment). We assure you <br />
that we will provide hassle-free refund.
              ...
              <div className="new">
                <div className="up">
                  ...
                  <p style={{ marginTop: "0" }}>
                  It can mean two things: 1. Your order has been shipped and is out for delivery. 2. You <br />
may be facing some issues on the website. Do give our human a call for a quickly solution.
                  </p>
                </div>
                <div className="down">
                  <img
