      ...
      <div className="facialTwosec">
        ...
        <div className="right">
          ...
          <p>
            ...
            at one <br /> point. You can’t judge yourself or compare yourself to anyone
            else because we <br /> all have different journeys and experiences. You
            have to set your ego aside and <br /> embrace change. I know change can be
            scary, but it’s so rewarding in the end. <br /> Tracy’s Method allows for
            so much change and expansion in your mind, body, and soul, but only
            you can be the one to show up and make that happen.
          </p>
        </div>
      </div>
    </>
