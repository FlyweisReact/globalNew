    ...
    <>
      ...
      <div className="facialDesc">
        ...
        <p>
          ...
          traumatic cheerleading injury to my right elbow, resulting in {" "}
          multiple surgeries. After years of recovering, I went to the trainer
          auditions in September 2016, and just weeks later, received  the
        ...
        <p>
          ...
          an athlete and not being able to live your life how you want to {" "}
      ...
      <div className="facialTwosec">
        ...
        <div className="right">
          ...
          <p>
            ...
            at one  point. You can’t judge yourself or compare yourself to
            anyone else because we  all have different journeys and
            experiences. You have to set your ego aside and embrace
            change. I know change can be scary, but it’s so rewarding in the
            end.  Tracy’s Method allows for so much change and expansion
            in your mind, body,  and soul, but only you can be the one to
