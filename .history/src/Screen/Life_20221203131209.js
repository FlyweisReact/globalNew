    ...
    <>
      ...
      <div className="product">
        ...
        <Card className="ProductCard" style={{ width: "350px" }}>
          <Card.Body>
            <img src={img4} alt="" style={{ paddingTop: "100px" }} onClick={() => NavigationHandler('/single')} />
          </Card.Body>
        </Card>
        <div className="desc2">
          <p>
        ...
        <Card className="ProductCard" style={{ width: "350px" }}>
          <Card.Body>
            <img src={img6} alt="" style={{ paddingTop: "50px" }} onClick={() => NavigationHandler('/single')} />
          </Card.Body>
        </Card>
        <div className="desc2">
          <p>
      ...
      <div className="pro" style={{ marginTop: "5%" }}>
        <h1>BEST DEALS</h1>
        <button className="shop" onClick={() => NavigationHandler('/allProduct')}>Shop Now</button>
      </div>
